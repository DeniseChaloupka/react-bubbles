...
- [*] Explain what a token is used for.
  ...
  *A server will issue a JWT (JSON Web Token) in exchange for validated log in credentials so that the app can then provide proof that it is authenticated with that server.

- [*] What steps can you take in your web apps to keep your data secure?

  *Use protected routes so that only authenticated users can access certain components/services

- [*] Describe how web servers work.

  *A server is a computer that holds the code for a website/application. A server is also the program that controls that computer and governs how the information is accessed and used.
